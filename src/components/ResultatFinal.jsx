...
export default function ResultatFinal() {
    ...
    return (
        <div className="resultat-contenedor">
            <Header />
            <div className="resultat-main">
                <h1>Puntuació</h1>
                ...
                <p className="resultat-punts">
                    Punts obtinguts: <span>{punts}</span>
                </p>
                <p className="resultat-missatge">{getMissatge()}</p>
            </div>
        </div>
    );
}
